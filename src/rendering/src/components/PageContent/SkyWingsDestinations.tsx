...
const SkyWingsServices = ({ fields, params }: SkyWingsDestinationsProps): JSX.Element => {
...
export const Default = withDatasourceCheck()<SkyWingsDestinationsProps>(SkyWingsServices);
