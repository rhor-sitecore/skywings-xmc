...
export type SkyWingsDestinationsBannerProps = ComponentProps & {
    fields: {
        Title: Field<string>;
...
const SkyWingsDestinationsBanner = (props: SkyWingsDestinationsBannerProps): JSX.Element => {
    return (
        <>
...
export const Default = withDatasourceCheck()<SkyWingsDestinationsBannerProps>(SkyWingsDestinationsBanner);
